...
function setup() 
{
  ...
  star.addImage(starr_img);
  star.scale = 0.02;

  star2 = createSprite(50,330,20,20);
  star2.addImage(starr_img);
  star2.scale = 0.02;
  ...
  star_display.changeImage("empty")
...
function draw() 
{
  ...
  if(collide(fruit,star,20)== true) {
    star.visible = false;
    star_display.changeImage("one");
  }
  if(collide(fruit,star2,40)== true) {
    star2.visible = false;
    star_display.changeImage("two");
  }
